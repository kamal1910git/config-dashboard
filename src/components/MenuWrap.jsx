...
class LeftNav extends Component {
  ...
  getItems() {
    ...
    switch (this.props.menus[this.state.currentMenu].items) {
      case 1:
        items = [
          <a key="0" href=""><i className="fa fa-fw fa-bar-chart-o" /><span>Dashboard</span></a>,
          <a key="1" href=""><i className="fa fa-fw fa-star-o" /><span>Favorites</span></a>,
          <a key="2" href=""><i className="fa fa-fw fa-bell-o" /><span>Alerts</span></a>,
          <a key="3" href=""><i className="fa fa-fw fa-envelope-o" /><span>Messages</span></a>,
          <a key="4" href=""><i className="fa fa-fw fa-comment-o" /><span>Comments</span></a>,          
